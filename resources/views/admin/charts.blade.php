...
<body id="page-top">
  ...
  <script src="<?php echo url('/'); ?>/js/demo/chart-bar-demo.js"></script> -->
<script>
...
var myLineChart = new Chart(ctx, {
  type: 'line',
  data: {
    labels: ["Jannnn", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
    datasets: [{
      label: "Earnings",
      lineTension: 0.3,
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [500000, 10000, 5000, 15000, 10000, 20000, 15000, 25000, 20000, 30000, 250000, 40000],
    }],
  },
  options: {
