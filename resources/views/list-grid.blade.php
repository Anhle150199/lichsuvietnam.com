            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="vizewNav">
                        ...
                        <!-- Nav brand -->
                        <a href="index.html" class="nav-brand"><img src="<?php echo url('/'); ?>/img/core-img/logo.png" alt=""></a>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="sidebar-area">
                        ...
                        <div class="single-widget latest-video-widget mb-50">
                            ...
                            <div class="single-blog-post d-flex">
                                <div class="post-thumbnail">
                                    <img src="<?php echo url('/'); ?>/img/bg-img/35.jpg" alt="">
                                </div>
                                <div class="post-content">
                        ...
                        <div class="single-widget add-widget mb-50">
                            <a href="#"><img src="<?php echo url('/'); ?>/img/bg-img/add.png" alt=""></a>
                        </div>
                        ...
                        <div class="single-widget youtube-channel-widget mb-50">
                            ...
                            <div class="single-youtube-channel d-flex align-items-center">
                                <div class="youtube-channel-thumbnail">
                                    <img src="<?php echo url('/'); ?>/img/bg-img/25.jpg" alt="">
                                </div>
                            ...
                            <div class="single-youtube-channel d-flex align-items-center">
                                <div class="youtube-channel-thumbnail">
                                    <img src="<?php echo url('/'); ?>/img/bg-img/26.jpg" alt="">
                                </div>
                                <div class="youtube-channel-content">
                            ...
                            <div class="single-youtube-channel d-flex align-items-center">
                                <div class="youtube-channel-thumbnail">
                                    <img src="<?php echo url('/'); ?>/img/bg-img/27.jpg" alt="">
                                </div>
                                <div class="youtube-channel-content">
                            ...
                            <div class="single-youtube-channel d-flex align-items-center">
                                <div class="youtube-channel-thumbnail">
                                    <img src="<?php echo url('/'); ?>/img/bg-img/28.jpg" alt="">
                                </div>
                                <div class="youtube-channel-content">
                            ...
                            <div class="single-youtube-channel d-flex align-items-center">
                                <div class="youtube-channel-thumbnail">
                                    <img src="<?php echo url('/'); ?>/img/bg-img/29.jpg" alt="">
                                </div>
                                <div class="youtube-channel-content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        <!-- Logo -->
                        <a href="index.html" class="foo-logo d-block mb-4"><img src="<?php echo url('/'); ?>/img/core-img/logo2.png" alt=""></a>
